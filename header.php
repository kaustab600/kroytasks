...
<nav class="navbar navbar-default">
	  <div class="container-fluid">
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="home.php">Manobbondhu</a>
	    </div>
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
			...
			$run_user = mysqli_query($con,$getuser) or die(mysqli_error($con));
			...
			$run_posts = mysqli_query($con,$user_posts) or die(mysqli_error($con)); 
